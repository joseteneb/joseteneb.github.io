...
ifdef NAME
	...
	echo "Authors: " >> $(INPUTDIR)/$(SLUG).$(EXT)
	echo "lang: " >> $(INPUTDIR)/$(SLUG).$(EXT)
...
.PHONY: html help clean regenerate serve serve-global devserver publish ssh_upload rsync_upload dropbox_upload ftp_upload s3_upload cf_upload github newpost newpage
